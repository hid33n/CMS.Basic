        ...
        <nav className="flex items-center space-x-4 relative">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            <div
              ...
              className={`absolute bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded shadow-md mt-2 z-10 min-w-max transition-opacity duration-200 ${dropdownOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
            >
              <button
                onClick={() => {
          ...
          <button onClick={() => scrollTo(refs.blogRef)} className="hover:text-indigo-500">Blog</button>
          <button onClick={() => scrollTo(refs.aboutRef)} className="hover:text-indigo-500">Nosotros</button>
          <button onClick={() => scrollTo(refs.contactRef)} className="hover:text-indigo-500">Contacto</button>
